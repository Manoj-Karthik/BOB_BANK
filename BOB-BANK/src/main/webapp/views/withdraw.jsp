...
<nav class="navbar navbar-expand-lg navbar-light fixed-top">
    <a style="text-decoration: none;" style="text-decoration: none;" class="navbar-brand" href="/">BOB_BANK</a>
...
</nav>        <h1>WITHDRAW FORM</h1>
    <form:form method="POST" modelAttribute="withdraw"  action="/withdrawamount">
